...
async function salvarLote(lista: Edital[], fonte?: string) {
  const r = salvarEditaisLote(lista, fonte || 'scraper-api')
  return { inseridos: r.inseridos, duplicados: r.duplicados, erros: r.erros, novos: r.novos }
}
